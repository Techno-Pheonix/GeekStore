    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-deepbluesky p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                    <div class="sidebar-brand-icon rotate-n-15"><img src="../pictures/logof2.png" width="50px" class="pulse animated infinite"></div>
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link" href="Users.php"><i class="fas fa-users"></i><span>Users</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                        <form class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group"><input class="bg-light form-control border-0 small" type="text" placeholder="Search for ...">
                                <div class="input-group-append"><button class="btn btn-primary bg-gradient-deepbluesky bg-gradient-deepbluesky py-0" type="button"><i class="fas fa-search"></i></button></div>
                            </div>
                        </form>
                        <ul class="nav navbar-nav flex-nowrap ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow mx-1" role="presentation">
                                <div class="nav-item dropdown no-arrow"><button class="btn btn-primary bg-gradient-deepbluesky bg-gradient-deepbluesky dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button"><span class="badge badge-danger badge-counter">3+</span><i class="fas fa-bell fa-fw"></i></button>
                            ...
                            <li class="nav-item dropdown no-arrow mx-1" role="presentation">
                                <div class="nav-item dropdown no-arrow"><button class="btn btn-primary bg-gradient-deepbluesky bg-gradient-deepbluesky dropdown-toggle" data-toggle="dropdown" aria-expanded="false" type="button"><i class="fas fa-envelope fa-fw"></i><span class="badge badge-danger badge-counter">7</span></button>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-list dropdown-menu-right animated--grow-in"
                                        role="menu">
                                        <h6 class="dropdown-header">alerts center</h6>
                                        <a class="d-flex align-items-center dropdown-item" href="#">
            ...
            <div class="container-fluid">
                <h3 class="text-dark mb-4" style="margin-bottom: 10px;">Product</h3><button class="btn btn-primary bg-gradient-deepbluesky bg-gradient-deepbluesky" type="button" style="margin-bottom: 15px;">Create New</button>
                <div class="row mb-3">
                    <div class="col-lg-4">
                        <?php 
                        echo "<div class=\"card mb-3\">
                        <div class=\"card-body text-center shadow\"><img class=\"rounded-circle mb-3 mt-4\" src=\"../pictures/".$row['picture']."\" width=\"160\" height=\"160\">
                            <div class=\"mb-3\"><button class=\"btn btn-primary bg-gradient-deepbluesky bg-gradient-deepbluesky btn-sm\" type=\"button\">Change Photo</button></div>
                        </div>
                        </div>";
                        ?>
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <h4 class="small font-weight-bold">Server migration<span class="float-right">40%</span></h4>
                                    ...
                                    <div class="card-body">
                                        <form action="Update_product.php" method="post">
                                            ...
                                            echo "<div class=\"form-group\">";
                                                ...
                                                ?>
                                            <div class="form-group"><button class="btn btn-primary bg-gradient-deepbluesky bg-gradient-deepbluesky btn-sm" type="submit" name="pInfo">Save Settings</button></div>
                                        </form>
                                    </div>
                                </div>
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        <form action="Update_product.php" method="post">
                                            ...
                                            <div class="form-group"><button class="btn btn-primary bg-gradient-deepbluesky bg-gradient-deepbluesky btn-sm" type="submit" name="shopInfo">Save&nbsp;Settings</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
