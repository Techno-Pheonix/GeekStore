      ...
      <nav aria-label="breadcrumb" class="mt-3">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a
              href="./index.php?<?php echo $catg; ?><?php echo $sub_catg; ?>"><?php echo $_GET["sub_catg"]; ?></a></li>
          <?php endif; ?>
        </ol>
      </nav>
        ...
        <div class="col-md-4 col-xl-3 bg-light">
          <section>
            ...
            <ul class="dropdown-ul">
              <a href="./index.php?catg=<?php echo $row["slug"] ?>" class="catg_target w-100">
                <li class="cat-item"><span
                    class="btn btn-primary center px-1 py-1 w-100"><?php echo $row['title'] ?></span>
              </a>
              <ul class="bg-liste-cat w-100">
                ...
                <a href="./index.php?catg=<?php echo $row["slug"] ?>&sub_catg=<?php echo $row_cat["title"] ?> "
          ...
          <form action="./index.php" method="get" class="my-4">
            ...
            <div class="d-flex">
              ...
              <button id="sbtn" class="btn btn-light my-2 my-sm-0" type="submit"><i
                  class="fas fa-search bs"></i></button>
            </div>
          </form>
          ...
          <div class="d-flex align-items-center justify-content-center mb-5">
            <div class="middle">
              <form action="index.php?<?php echo ''.$catg; ?><?php echo ''.$sub_catg; ?><?php echo ''.$search; ?>"
                method="POST">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="min"
                          value="<?php if (isset($_POST["min"])) echo($_POST["min"]);?> " aria-describedby="emailHelp"
                          placeholder="Min">
                      </div>
                    </div>
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" name="max"
                          value="<?php if (isset($_POST["max"])) echo($_POST["max"]);?> " aria-describedby="emailHelp"
                          placeholder="Max">
                      </div>
                    </div>
                  </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-xl-4 col-sm-12 mb-2">
            <div class="card h-100">
              <img class="card-img-top img-fluid" width=175px height=200px;
                src="../pictures/<?php echo $row["picture"]?>" alt="Card image cap">
              <div class="card-body">
